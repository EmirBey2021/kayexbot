...
exports.run = async (client, message, args) => {
   if(!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send("Bu Komutu Kullanabilmek İçin **YÖNETİCİ** Yetkisine Sahip Olman Gerek.")
    ...
    .setFooter(`${kazanacak} kazanan | ID: ${cekilisid} | Kayex Creative#0001 Tarafından Sağlanmıştır | Bitecek:`)
                ...
                if (kalanzaman <= 0) {
                  ...
                  clearInterval(interval)
                    ...
                    if (asilkisisayisi < kazanacak) {
                        ...
                        .setFooter(`${kazanacak} kazanan | Kayex Creative#0001 Tarafından Sağlanmıştır | ID: ${cekilisid} | Bitti:`)
                        .setTimestamp(bitecegizamanms)
                        .setColor("#2F3136")
                        msg.edit(embed)
